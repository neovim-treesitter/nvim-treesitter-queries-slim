# nvim-treesitter-queries-slim

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-slim/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-slim/actions/workflows/validate.yml)

Neovim tree-sitter queries for **slim**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-slim",
...
- [ ] Changes are scoped to `slim` — do not include files for other languages
